...
function fetchArea(props) {
    return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
        const { rectangle, northEast, northWest, southWest, southEast, } = (0, createRectangle_1.createRectangle)(props);
        ...
        if (response && "data" in response) {
            ...
            let geoJSON = (0, osmtogeojson_1.default)(response.data, { flatProperties: false });
